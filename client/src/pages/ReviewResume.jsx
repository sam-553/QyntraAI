...
import { Edit, Eraser, FileText, Sparkles } from 'lucide-react'
...
accept='application/pdf'
        ...
        <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#008a3d] to-[#009bb3] text-white px-4 py-2 mt-6 text-sm rounded-lg">
