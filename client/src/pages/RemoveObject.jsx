...
import { Edit, Eraser, Scissors, Sparkles } from 'lucide-react'
  ...
  return (
    <div className="h-full overflow-y-auto p-6 flex flex-col lg:flex-row gap-6 text-slate-700">
      ...
      <form
        ...
        className="w-full lg:max-w-lg p-4 bg-white rounded-lg border border-gray-200 h-[450px]"
      >
...
accept='image/*'
       ...
       <p className="mt-6 text-sm font-medium">Describe object Name To Remove</p>
        ...
        <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#417df6] to-[#8e37eb] text-white px-4 py-2 mt-6 text-sm rounded-lg">
